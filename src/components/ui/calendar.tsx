  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          buttonVariants({ variant: "outline", style: "icon" }),
        ...
        cell: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent [&:has([aria-selected].day-range-end)]:rounded-r-full [&:has([aria-selected].day-range-start)]:rounded-l-full",
          props.mode === "range"
